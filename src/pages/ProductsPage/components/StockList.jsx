            ...
            <div className="flex flex-wrap justify-between items-center gap-4 pt-4">
                ...
                <div className="py-3">
                    ...
                    <button
                        ...
                        className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-verde-stock text-white gap-2 pl-4 text-sm font-bold leading-normal tracking-[0.015em] transition-colors hover:bg-opacity-90"
                    >
