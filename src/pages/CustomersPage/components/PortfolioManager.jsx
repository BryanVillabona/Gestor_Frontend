    ...
    <section className="p-4 sm:p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <article className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <form onSubmit={handlePaymentSubmit} className="space-y-6">
          ...
          <button type="submit" className="flex ... h-10 px-4 bg-primary text-gray-800 ... text-sm font-bold w-full justify-center">
            Registrar Abono
          </button>
        </form>
      </article>
      ...
      <article className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <form onSubmit={handlePortfolioSubmit} className="space-y-6">
          ...
          <button type="submit" className="flex ... h-10 px-4 bg-gray-200 ... text-sm font-bold w-full justify-center">
