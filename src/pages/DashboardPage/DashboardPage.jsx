...
const DashboardPage = () => {
  ...
  return (
    ...
    <section className="flex flex-col gap-8">
      ...
      <nav className="flex flex-col sm:flex-row flex-wrap gap-4">
        <Link
          to="/ventas" // Enlaza a la página de ventas
          className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-primary h-14 px-6 text-base font-bold text-gray-800 hover:bg-primary/90 transition-colors"
        >
          <span className="material-symbols-outlined">add_shopping_cart</span>
          <span>Registrar Nueva Venta</span>
        </Link>
        <Link
          to="/productos" // Enlaza a la página de productos (para la pestaña de stock)
          className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-[#28A745] h-14 px-6 text-base font-bold text-white hover:bg-[#28A745]/90 transition-colors"
        >
